...
public class ThreeWayTestHelper : IDisposable
{
	...
	/// <summary>
	/// Write data to memory in both emulators
	/// </summary>
	...
	/// <summary>
	/// Execute one instruction in both emulators
	/// </summary>
	...
	/// <summary>
	/// Assert that a register matches across both emulators
	/// </summary>
	...
	/// <summary>
	/// Assert that specific flags match across both emulators
	/// </summary>
	...
	/// <summary>
	/// Assert that memory matches across both emulators
	/// </summary>
