...
namespace IgNTeas.Generated
{
	...
	public class Function_004071F0
	{
		...
		public int Execute(uint a1)
		{
			...
			{
			return CallFunction(0x00407910, a1);
			}
			...
			if (v14 <= v15)
			{
			CallFunction(0x00456180, dword_44CE38,  & dword_44CE00);
			dword_44CE00 = dword_41CAAC;
			dword_44CE04 = dword_41CAB0;
			...
			CallFunction(0x004561C0, dword_44CE3C,  & dword_44CE00);
			...
			dword_44CE18 = dword_41CAD4;
			dword_44CE1C = dword_41CAD8;
			CallFunction(0x00456180, dword_44CE40,  & dword_44CE00);
			v26 = 0;
			v27 = 0;
			...
			while ( * (dword_44CE40 + 4) > v31)
			}
			}
			else
			{
			CallFunction(0x004561C0, dword_44CE38,  & dword_44CE00);
			dword_44CE00 = dword_41CAAC;
			dword_44CE04 = dword_41CAB0;
			dword_44CE08 = dword_41CABC;
			dword_44CE0C = dword_41CAC0;
			...
			dword_44CE18 = dword_41CAD4;
			dword_44CE1C = dword_41CAD8;
			CallFunction(0x00456180, dword_44CE3C,  & dword_44CE00);
			dword_44CE00 = dword_41CAB4;
			dword_44CE04 = dword_41CAB8;
			dword_44CE08 = dword_41CABC;
			dword_44CE0C = dword_41CAC0;
			...
			dword_44CE18 = dword_41CAD4;
			dword_44CE1C = dword_41CAD8;
			CallFunction(0x004561C0, dword_44CE40,  & dword_44CE00);
			v16 = 0;
			...
			do
			{
			v24 = (v23 + dword_44CE3C);
			v23 += 12;
			v36 = (v22 + dword_44CE40 + 8);
			v25 =  * (v22 + dword_44CE40 + 16);
			v22 += 12;
			++v20;
			// TODO: Transpile: sub_407150(
