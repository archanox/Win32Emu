...
/// <summary>
/// COM interface definitions for IDirectDrawSurface3 that extends IDirectDrawSurface2
/// IDirectDrawSurface3 has the same methods but uses DDSURFACEDESC2 instead of DDSURFACEDESC
/// Reference: https://learn.microsoft.com/en-us/windows/win32/api/ddraw/nn-ddraw-idirectdrawsurface3
/// </summary>
public static class IDirectDrawSurface3
{
	...
	// IDirectDrawSurface methods (3-35) - same as IDirectDrawSurface
	...
	// IDirectDrawSurface3 has no new methods - same as IDirectDrawSurface2 but uses DDSURFACEDESC2
}
