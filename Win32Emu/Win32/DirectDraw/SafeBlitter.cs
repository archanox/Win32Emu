...
{
	/// <summary>
	/// Safe blitter implementation using portable Span operations.
	/// Compatible with all platforms including WASM Blazor.
	/// </summary>
	public class SafeBlitter : IBlitter
	{
		/// <summary>
		/// Singleton instance of the safe blitter.
		/// </summary>
		public static SafeBlitter Instance { get; } = new SafeBlitter();
		...
		private void BltWithSourceColorKey8Bpp(
			Span<byte> dest,
			ReadOnlySpan<byte> src,
			int destPitch,
			int srcPitch,
		...
		private void BltWithSourceColorKey16Bpp(
			Span<byte> dest,
			ReadOnlySpan<byte> src,
			int destPitch,
			int srcPitch,
		...
		private void BltWithSourceColorKey32Bpp(
			Span<byte> dest,
			ReadOnlySpan<byte> src,
			int destPitch,
			int srcPitch,
		...
		private void BltStretchWithColorKey8Bpp(
			Span<byte> dest,
			ReadOnlySpan<byte> src,
		...
		private void BltStretchWithColorKey16Bpp(
			Span<byte> dest,
			ReadOnlySpan<byte> src,
			int destX, int destY, int destWidth, int destHeight, int destSurfaceWidth,
			int srcX, int srcY, int srcWidth, int srcHeight, int srcSurfaceWidth,
		...
		private void BltStretchWithColorKey32Bpp(
			Span<byte> dest,
			ReadOnlySpan<byte> src,
			int destX, int destY, int destWidth, int destHeight, int destSurfaceWidth,
			int srcX, int srcY, int srcWidth, int srcHeight, int srcSurfaceWidth,
		...
		/// </summary>
		public void Clear(Span<byte> buffer, byte value)
		{
