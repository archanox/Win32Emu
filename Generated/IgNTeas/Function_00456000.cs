...
namespace IgNTeas.Generated
{
	...
	public class Function_00456000
	{
		...
		public int Execute()
		{
			...
			v0 = (v1 / dword_41CB30) >> 1;
			}
			dword_41CB48 = v0;
			dword_41CB38 = dword_41CAB4 - dword_41CAAC;
			dword_41CB3C = (v0 * (2 * (dword_41CABC - dword_41CAAC))) >> 32;
			dword_41CB40 = (v0 * (2 * (dword_41CAD4 - dword_41CAC4))) >> 32;
			dword_41CB44 = (v0 * (2 * (dword_41CAD8 - dword_41CAC8))) >> 32;
			v2 = dword_41CB3C - (dword_41CAB4 - dword_41CAAC);
			if (v2 >= -2 && v2 <= 2)
			v2 = 4 * ((v2 >> 2) | 1);
			dword_41CB34 = v2;
			dword_41CADC = ((dword_41CAC4 + dword_41CB40 - dword_41CACC) << 16) / v2;
			dword_41CAEC = 0;
			...
			dword_41CAE0 = ((dword_41CAC8 + dword_41CB44 - dword_41CAD0) << 16) / v2;
