...
/// <summary>
/// COM interface definitions for IDirectDrawSurface7 that extends IDirectDrawSurface4
/// IDirectDrawSurface7 adds SetPriority, GetPriority, SetLOD, and GetLOD methods
/// Reference: https://learn.microsoft.com/en-us/windows/win32/api/ddraw/nn-ddraw-idirectdrawsurface7
/// </summary>
public static class IDirectDrawSurface7
{
	...
	// IDirectDrawSurface4 methods (39-44)
	...
	// IDirectDrawSurface7 new methods (45-48)
	
	/// <summary>
	/// HRESULT SetPriority(DWORD dwPriority);
	/// </summary>
	[UnmanagedFunctionPointer(CallingConvention.StdCall)]
	public delegate int SetPriority(IntPtr pThis, uint dwPriority);
	
	/// <summary>
	/// HRESULT GetPriority(LPDWORD lpdwPriority);
	/// </summary>
	[UnmanagedFunctionPointer(CallingConvention.StdCall)]
	public delegate int GetPriority(IntPtr pThis, IntPtr lpdwPriority);
	
	/// <summary>
	/// HRESULT SetLOD(DWORD dwMaxLOD);
	/// </summary>
	[UnmanagedFunctionPointer(CallingConvention.StdCall)]
	public delegate int SetLOD(IntPtr pThis, uint dwMaxLOD);
	
	/// <summary>
	/// HRESULT GetLOD(LPDWORD lpdwMaxLOD);
	/// </summary>
	[UnmanagedFunctionPointer(CallingConvention.StdCall)]
	public delegate int GetLOD(IntPtr pThis, IntPtr lpdwMaxLOD);
}
