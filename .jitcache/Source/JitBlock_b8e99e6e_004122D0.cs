...
{
    /// <summary>
    /// Auto-generated JIT code for block at 0x004122D0
    /// Generated from RTL intermediate representation
    /// </summary>
    public class JitBlock_b8e99e6e_004122D0
    {
        public async Task<CpuStepResult> Execute(dynamic cpu, dynamic mem)
        {
            ...
            // Block at offset 0x4122D0
            ESP = ESP - 0x4u; // @0x4122D0
            mem.Write32(ESP, EBX); // @0x4122D0
            ESP = ESP - 0x4u; // @0x4122D1
            mem.Write32(ESP, ESI); // @0x4122D1
            ESI = (ESP + 0x10u); // @0x4122D2
            ESP = ESP - 0x4u; // @0x4122D6
            mem.Write32(ESP, EDI); // @0x4122D6
            FLAGS = (ESI - 0x0u); // @0x4122D7
            EAX = ESI; // @0x4122DA
