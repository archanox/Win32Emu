...
namespace Win32Emu.Gui.Backends.DirectDraw
{
	/// <summary>
	...
	/// Use this on desktop platforms for maximum performance.
	/// </summary>
	public class SimdBlitter : Win32Emu.Win32.DirectDraw.IBlitter
	{
		/// <summary>
		/// Singleton instance of the SIMD blitter.
		/// </summary>
		public static SimdBlitter Instance { get; } = new SimdBlitter();
		...
		/// </summary>
		public void BltWithSourceColorKey(
			Span<byte> dest,
			ReadOnlySpan<byte> src,
			int destPitch,
			int srcPitch,
		...
		private unsafe void BltFast8Bpp(
			Span<byte> dest,
			ReadOnlySpan<byte> src,
			int destPitch,
			int srcPitch,
		...
		private unsafe void BltWithSourceColorKey8Bpp(
			Span<byte> dest,
			ReadOnlySpan<byte> src,
			int destPitch,
			int srcPitch,
		...
		private unsafe void BltFast16Bpp(
			Span<byte> dest,
			ReadOnlySpan<byte> src,
			int destPitch,
			int srcPitch,
		...
		private unsafe void BltWithSourceColorKey16Bpp(
			Span<byte> dest,
			ReadOnlySpan<byte> src,
			int destPitch,
			int srcPitch,
		...
		private unsafe void BltFast24Bpp(
			Span<byte> dest,
			ReadOnlySpan<byte> src,
			int destPitch,
			int srcPitch,
		...
		private unsafe void BltFast32Bpp(
			Span<byte> dest,
			ReadOnlySpan<byte> src,
			int destPitch,
			int srcPitch,
		...
		private unsafe void BltWithSourceColorKey32Bpp(
			Span<byte> dest,
			ReadOnlySpan<byte> src,
			int destPitch,
			int srcPitch,
		...
		/// </summary>
		public void BltStretchWithColorKey(
			Span<byte> dest,
			ReadOnlySpan<byte> src,
			int destX,
			int destY,
		...
		private unsafe void BltStretchWithColorKey8Bpp(
			Span<byte> dest,
			ReadOnlySpan<byte> src,
		...
		private unsafe void BltStretchWithColorKey16Bpp(
			Span<byte> dest,
			ReadOnlySpan<byte> src,
			int destX, int destY, int destWidth, int destHeight, int destSurfaceWidth,
			int srcX, int srcY, int srcWidth, int srcHeight, int srcSurfaceWidth,
		...
		private unsafe void BltStretchWithColorKey32Bpp(
			Span<byte> dest,
			ReadOnlySpan<byte> src,
			int destX, int destY, int destWidth, int destHeight, int destSurfaceWidth,
			int srcX, int srcY, int srcWidth, int srcHeight, int srcSurfaceWidth,
		...
		/// </summary>
		public unsafe void Clear(Span<byte> buffer, byte value)
		{
		...
		private unsafe void CopyAdaptive(byte* dest, byte* src, int size)
		{
