...
namespace IgNTeas.Generated
{
	...
	public class Function_00407910
	{
		...
		public int Execute(int a1)
		{
			...
			CallFunction(0x00407130, dword_41CAE0, dword_41CADC, dword_44CE24,  * (_DWORD * )(a1 + 56));
			...
			if (v2 < = v3)
			{
			CallFunction(0x00456520, (int * )dword_44CE38, &dword_44CE60);
			dword_44CE60 = dword_41CAAC;
			dword_44CE64 = dword_41CAB0;
			...
			CallFunction(0x00456640, (int * )dword_44CE3C, &dword_44CE60);
			...
			dword_44CE78 = dword_41CAD4;
			dword_44CE7C = dword_41CAD8;
			CallFunction(0x00456520, (int * )dword_44CE40, &dword_44CE60);
			v12 = 0;
			v13 = 0;
			...
			// TODO: Transpile: v12 += 12;
			// TODO: Transpile: ++v13;
			// TODO: Transpile: dword_44CE30 += dword_45305C;
			}
			// TODO: Transpile: while ( *(_DWORD *)(dword_44CE38 + 4) > v13 );
			}
			result = dword_44CE40;
			v15 = 0;
			v16 = 0;
			...
			// TODO: Transpile: while ( *(_DWORD *)(dword_44CE40 + 4) > v16 );
			}
			}
			// TODO: Transpile: else
			{
			CallFunction(0x00456640, (int * )dword_44CE38, &dword_44CE60);
			dword_44CE60 = dword_41CAAC;
			dword_44CE64 = dword_41CAB0;
			dword_44CE68 = dword_41CABC;
			dword_44CE6C = dword_41CAC0;
			...
			dword_44CE78 = dword_41CAD4;
			dword_44CE7C = dword_41CAD8;
			CallFunction(0x00456520, (int * )dword_44CE3C, &dword_44CE60);
			dword_44CE60 = dword_41CAB4;
			dword_44CE64 = dword_41CAB8;
			dword_44CE68 = dword_41CABC;
			dword_44CE6C = dword_41CAC0;
			...
			dword_44CE78 = dword_41CAD4;
			dword_44CE7C = dword_41CAD8;
			CallFunction(0x00456640, (int * )dword_44CE40, &dword_44CE60);
			v4 = 0;
			...
			// TODO: Transpile: v5 += 12;
			// TODO: Transpile: ++v4;
			// TODO: Transpile: dword_44CE30 += dword_45305C;
			}
			// TODO: Transpile: while ( *(_DWORD *)(dword_44CE38 + 4) > v4 );
			}
			v7 = 0;
			result = dword_44CE40;
			if ( * (int * )(dword_44CE40 + 4) > 0)
			...
			// TODO: Transpile: v10 += 12;
			// TODO: Transpile: dword_44CE30 += dword_45305C;
			result = dword_44CE40;
			// TODO: Transpile: v9 += 12;
			// TODO: Transpile: ++v7;
			}
			// TODO: Transpile: while ( *(_DWORD *)(dword_44CE40 + 4) > v7 );
			}
			}
			}
			}
